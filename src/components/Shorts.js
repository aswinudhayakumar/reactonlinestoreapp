...
class Shorts extends Component {
    ...
    render() {
        ...
        if (this.state.decode.Account === 'Seller') {
            var display = <div>
                <h2 className="head"><img src={short} height="60px" width="80px" alt="" /> Now showing Shorts</h2>
                <div className="row">
                    {
...

                            {
                                this.state.products.map((data) => {
                                    this.state.decode.Account === 'Seller' ?
                                        data.Category === 'Shorts' && data.Sellerid === this.state.decode.Userid ? value = 1 : console.log('') :
                                        data.Category === 'Shorts' ? value = 1 : console.log('')
                                    return ('')
