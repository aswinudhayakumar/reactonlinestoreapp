...
class Pants extends Component {
    ...
    render() {
        ...
        if (this.state.decode.Account === 'Seller') {
            var display = <div>
                <h2 className="head">Now showing Pants</h2>
                <div className="row">
                    {
...

                            {
                                this.state.products.map((data) => {
                                    ...
                                    this.state.decode.Account === 'Seller' ?
                                        data.Category === 'Pant' && data.Sellerid === this.state.decode.Userid ? value = 1 : console.log("no") :
                                        data.Category === 'Pant' ? value = 1 : console.log("no")
